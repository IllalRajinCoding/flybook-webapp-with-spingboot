...
<html lang="id" data-theme="light">
  ...
  <body class="antialiased min-h-screen">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <span class="text-lg font-black tracking-tighter text-slate-900"
            >FlyBook <span class="text-accent italic">Admin</span></span
          >
        </div>
        ...
        <div class="flex items-center gap-4">
          ...
          <div
            class="w-9 h-9 bg-slate-100 border border-slate-200 rounded flex items-center justify-center font-bold text-slate-700"
          >
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
      <div class="mb-8">
        <a
          ...
          class="text-accent text-sm font-bold hover:underline inline-flex items-center gap-2 mb-4"
        >
          <i class="fas fa-arrow-left text-xs"></i> Kembali ke Dashboard
        </a>
        <h2 class="text-3xl font-black text-slate-950 tracking-tight">
          Buat Unit Penerbangan Baru
        </h2>
        <p class="text-slate-500 font-medium mt-1 text-sm">
          Input data penerbangan dengan teliti sebelum dipublikasikan ke sistem.
        </p>
      </div>
        ...
        >
          <div class="p-8 md:p-10">
            <div class="flex items-center gap-3 mb-8">
              <span
                class="w-6 h-6 rounded bg-slate-950 text-white flex items-center justify-center text-[10px] font-bold"
                >01</span
              >
              <h3
                class="font-black text-slate-900 uppercase tracking-wider text-sm"
              >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="form-control md:col-span-2">
                ...
                <input
                  ...
                  name="penerbangan"
                  required
                  placeholder="Contoh: Boeing 737-800NG"
                  class="input input-bordered pro-input w-full"
                />
              </div>
              ...
              <div class="form-control">
                ...
                <div class="relative">
                  <i
                    class="fas fa-plane-departure absolute left-3 top-3.5 text-slate-300 text-sm"
                  ></i>
                  <input
                    type="text"
                    name="bandara_asal"
              ...
              <div class="form-control">
                ...
                <div class="relative">
                  <i
                    class="fas fa-plane-arrival absolute left-3 top-3.5 text-slate-300 text-sm"
                  ></i>
                  <input
                    type="text"
                    name="bandara_tujuan"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div class="form-control">
                ...
                <input
                  ...
                  required
                  placeholder="0"
                  class="input input-bordered pro-input w-full font-bold text-accent"
                />
              </div>
              ...
              <div class="form-control md:col-span-2">
                ...
                <select
                  name="status"
                  required
                  class="select select-bordered pro-input w-full"
                >
                  <option value="aktif">
                    PUBLISHED (Tersedia untuk Penumpang)
                  </option>
                  <option value="nonaktif">
                    DRAFT (Sembunyikan dari Sistem)
                  </option>
          ...
          <div
            class="p-8 md:p-10 bg-white flex flex-col sm:flex-row justify-between items-center gap-4"
          >
            <div class="flex items-center gap-3 text-slate-400">
              <i class="fas fa-circle-info"></i>
              <p
                class="text-[11px] font-bold uppercase tracking-tight leading-tight"
              >
                Data akan langsung disinkronisasi<br />dengan terminal
                penumpang.
              </p>
            </div>
            <div class="flex gap-3 w-full sm:w-auto">
              <a
                href="/dashboard/admin"
                class="btn btn-ghost flex-1 sm:flex-none font-bold text-slate-500"
                >Batalkan</a
              >
              <button
                type="submit"
                class="btn bg-slate-950 hover:bg-black text-white flex-1 sm:flex-none px-10 border-none font-bold"
              >
                Simpan & Publikasikan
              </button>
            </div>
    ...
    <footer class="text-center py-10 border-t border-slate-100 mt-10">
      ...
      >
        FlyBook Admin Control Tower — v2.0
      </p>
    </footer>
    ...
    <div id="toast" class="toast toast-top toast-end z-50 hidden">
      <div
        id="toast-alert"
        class="alert bg-red-50 border border-red-200 text-red-800 shadow-lg"
      >
